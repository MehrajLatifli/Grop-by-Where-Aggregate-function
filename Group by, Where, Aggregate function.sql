...
Select Employees.dbo.Employees.StartDate, Employees.dbo.Employees.CountryRegionName,
COUNT(*) as [Number of employees]
from Employees.dbo.Employees 
group by Employees.dbo.Employees.StartDate, Employees.dbo.Employees.CountryRegionName
...
Update Employees.dbo.History
set Employees.dbo.History.EndDate ='2014-05-05'
where Employees.dbo.History.BusinessEntityID >0 and Employees.dbo.History.BusinessEntityID <=90

select * from Employees.dbo.History

Update Employees.dbo.History
set Employees.dbo.History.EndDate ='2008-05-05'
where Employees.dbo.History.BusinessEntityID >90 and Employees.dbo.History.BusinessEntityID <=100

select * from Employees.dbo.History

Update Employees.dbo.History
set Employees.dbo.History.EndDate ='2020-05-15'
where Employees.dbo.History.BusinessEntityID >100
...
select
COUNT(*) as [Number of employees],
Employees.dbo.History.EndDate
from Employees.dbo.History 
group by Employees.dbo.History.EndDate 
...
SELECT * FROM Employees.dbo.History 
where YEAR(Employees.dbo.History.EndDate)-YEAR(Employees.dbo.History.StartDate) =0 AND MONTH(Employees.dbo.History.EndDate)-MONTH(Employees.dbo.History.StartDate)<12
